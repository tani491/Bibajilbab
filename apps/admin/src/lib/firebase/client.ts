...
export function getFirebaseClientStatus(): FirebaseClientStatus {
  ...
  return {
    ...
    usingEmulators: false,
    reason:
      "Configuration Firebase incomplète dans le fichier .env.local. Renseignez les variables NEXT_PUBLIC_FIREBASE_* ou activez le mode admin local en développement.",
  }
}
